    ...
    <section className="mx-auto max-w-7xl px-6 py-6 md:px-14">
      <div className="rounded-lg bg-white p-8 shadow-md">
        ...
        <p className="mb-4 text-gray-700">
          <strong>SHIPU LOGISTICS PRIVATE LIMITED</strong> believes in helping its customers as far
          as possible, and has therefore a liberal cancellation policy. Under this policy:
        </p>
        ...
        <p className="mb-4 text-gray-700">
          ...
          the issue at their end. This should be reported within <strong>1-2 days</strong> of
