    ...
    <section className="mx-auto max-w-7xl px-6 py-6 md:px-14">
      <div className="rounded-lg bg-white p-8 shadow-md">
        ...
        <p className="mb-4 text-gray-700">
          This privacy policy sets out how <strong>SHIPU LOGISTICS PRIVATE LIMITED</strong> uses and
          protects any information that you give <strong>SHIPU LOGISTICS PRIVATE LIMITED</strong>{' '}
          when you visit their website and/or agree to purchase from them. We are committed to
          ensuring that your privacy is protected. Should we ask you to provide certain information
          by which you can be identified when using this website, you can be assured that it will
          only be used in accordance with this privacy statement.
        </p>

        <p className="mb-4 text-gray-700">
          <strong>SHIPU LOGISTICS PRIVATE LIMITED</strong> may change this policy from time to time
          by updating this page. You should check this page from time to time to ensure that you
          adhere to these changes.
        </p>

        <h2 className="mb-2 text-xl font-semibold text-gray-900">Information We May Collect</h2>
        ...
        <ul className="mb-4 list-disc pl-6 text-gray-700">
          ...
          <li>
            Periodically send promotional emails about new products, special offers, or other
            information which we think you may find interesting using the email address you provided
          </li>
          <li>Contact you for market research purposes (via email, phone, fax, or mail)</li>
        ...
        <p className="mb-4 text-gray-700">
          ...
          you know when you visit a particular site.
        </p>
        <p className="mb-4 text-gray-700">
        ...
        <p className="mb-4 text-gray-700">
          ...
          us. You can choose to accept or decline cookies. Most web browsers automatically accept
        ...
        <ul className="mb-4 list-disc pl-6 text-gray-700">
          <li>
            ...
            click to indicate that you do not want the information to be used for direct marketing
            purposes.
          </li>
          <li>
            If you have previously agreed to us using your personal information for direct
            marketing, you may change your mind at any time by writing to or emailing us at{' '}
        ...
        <p className="mb-2 text-gray-700">
          <strong>
            N C 105, NEAR SBI OFFICER, KANKARBAGH, Ashok Nagar (Patna), Sampatchak, Patna - 800020,
            Bihar
          </strong>
        </p>
        <p className="mb-4 text-gray-700">
          Or contact us at <strong>7070472634</strong> or{' '}
          <a href="mailto:ayushkumar9315983@gmail.com" className="text-blue-600 underline">
            ayushkumar9315983@gmail.com
          </a>
        </p>
