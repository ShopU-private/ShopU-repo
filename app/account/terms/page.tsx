      ...
      <div className="rounded-lg bg-white p-8 shadow-md">
        ...
        <ul className="list-disc space-y-2 pl-6 text-gray-700">
          ...
          <li>
            ...
            to ensure that any products, services or information available through our website
          ...
          <li>
            You may not create a link to our website from another website or document without SHIPU
            LOGISTICS PRIVATE LIMITED&rsquo;s prior written consent.
          </li>
          <li>
