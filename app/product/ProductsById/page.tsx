...
export default function ProductView() {
  ...
  return (
    <div className="min-h-xl py-10">
      <div className="mx-auto grid w-[90%] max-w-7xl gap-8 rounded p-6 md:grid-cols-2">
        {/* Left: Image Gallery */}
        <div className="flex gap-6">
          <div className="flex flex-col items-center justify-between space-y-2">
            <button
              ...
              className="bg-background1 rounded-full px-4 py-2 text-xl text-white disabled:opacity-50"
            >
              ↑
            </button>
          ...
          <div className="jusify-center flex w-full flex-1 items-center rounded-lg bg-white p-6">
            <img
            ...
            <div className="flex flex-wrap gap-2">
              {sizes.map(size => (
                <button
                  ...
                  className={`cursor-pointer rounded px-5 py-2 text-sm transition duration-200 ${
      ...
      <div className="mx-auto w-[90%] max-w-7xl px-4 py-10">
        ...
        <div className="relative">
          ...
          <button
            onClick={() => scroll('left')}
            className="bg-background1 absolute top-[40%] left-0 z-10 flex h-8 w-8 items-center justify-center rounded-full text-white"
          >
            <svg
              className="h-4 w-4"
              fill="none"
          ...
          <div ref={scrollRef} className="no-scrollbar flex gap-4 overflow-x-auto px-4 py-4">
            {products.map((product, idx) => (
              <div
                key={idx}
                className="max-w-[210px] min-w-[210px] flex-shrink-0 rounded-lg bg-white p-3 shadow-sm transition-transform duration-300 hover:scale-102"
              >
                <img
                  src={product.image}
                  alt={product.title}
          ...
          <button
            ...
            className="bg-background1 absolute top-[40%] right-0 z-10 flex h-8 w-8 items-center justify-center rounded-full text-white"
          >
            <svg
              className="h-4 w-4"
              fill="none"
